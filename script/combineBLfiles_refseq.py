...
def loadCoordsToKeys(infileString):
    ...
    for line in infileLines[:-1]:
        ...
        if not coords in coordsToLabels:
            ...
            coordsToAccNums[coords] = acc_num
    ...
    return coordsToKey, coordsToLabels, coordsToAccNums
###########################################################################
...
for i in lengths:
    ...
    coordsToKey1, coordsToLabels1, coordsToAccNum1 = loadCoordsToKeys(infileString1)
    coordsToKey2, coordsToLabels2, coordsToAccNum2 = loadCoordsToKeys(infileString2)
    ...
    for coord in coordsToLabels1:
        ...
        coordsToAccNums[coord] = coordsToAccNum1[coord]

        # don't rly get it, removed
    ...
    for coord in coordsToLabels2:
        if coord not in coordsToLabels:
            ...
            coordsToAccNums[coord] = coordsToAccNum2[coord]
    ...
    for coord in coordsToKey:
        ...
        outList = [newId, chrom, acc_num, length, '0', '0', '1', length, rawStart, str(rawEnd)]
