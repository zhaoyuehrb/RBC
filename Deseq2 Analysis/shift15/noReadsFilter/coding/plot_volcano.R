...
plot_volcano <- function(res_tableDE, type, day,list_of_genes,label,folder_label,xlims,ylims){
  ...
  save_dir <- '/Users/Yue/Documents/HGLab/deseq_yue/Proper Version/trial_plots/'
...
plot_volcano(res_0_L24,'ER L24 T0',1,genes_table$cytoskeleton,'cytoskeleton','',xlims=c(-5,5), ylims=c(0,10))
