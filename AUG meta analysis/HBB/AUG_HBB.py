...
for chrom in chrList:
    ...
    for gene in chromToGenes[chrom]:
        ...
        if ORFlength >= 200 and accNum in selectGeneAccDict:
...
for base in xrange(-300, 1500, 1):
    base_outList = [base, (baseToReads[base]/float(numGenesContribute))]
    ...
    if base%3 == 0:
        codon = base/3
        codon_outList = [codon, (codonToReads[codon]/float(numGenesContribute))]
